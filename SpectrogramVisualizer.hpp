...
public:
    ...
    float TIME_YSCALE = 1;
    float TIME_ZSCALE = 1;
    float TIME_XSHIFT = 0.3;
    float TIME_YSHIFT = 0.9;
    float TIME_ZSHIFT = 0;

    float SPECTROGRAM_XSCALE = 0.029297;
    float SPECTROGRAM_YSCALE = 0.000242;
    float SPECTROGRAM_ZSCALE = 1;

    float SPECTROGRAM_XSHIFT = 0.05;
    float SPECTROGRAM_YSHIFT = 0.22;
    float SPECTROGRAM_ZSHIFT = 1;
    float REALFFT_XSHIFT = 0.1;
    float REALFFT_YSHIFT = 0.18;
    float REALFFT_MAX_X_FACTOR = 1;
    float REALFFT_MAXY = 0.001;
    float REALFFT_MAXZ = 5;
    float REALFFT_MARKER_MIN_DB = -50;
    float REALFFT_MARKER_MAX_DB = -120;

    float REALFFT_MARKER_GRADATION_X = 5;
    float REALFFT_MARKER_GRADATION_Y = 3;

   float SPECTROGRAM_AXIS_X_GRADATION_FACTOR = 4;
   float SPECTROGRAM_AXIS_Y_GRADATION_FACTOR = 10;
    float SPECTROGRAM_AXIS_MIN_DB = -160;
    float SPECTROGRAM_AXIS_MAX_DB = 20;
    float TIME_MIN = -0.1;
    float TIME_MAX = 0.1;
    float TIME_DOM_START = 0.05;
  /**
